...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#1E3A2B] text-white border-t border-[#D6A146]/30 shadow-2xl px-1 py-1.5 pb-[max(0.375rem,env(safe-area-inset-bottom))] min-h-[var(--mobile-nav-height)] flex items-center justify-around">
