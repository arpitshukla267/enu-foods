...
export const RecipesPage: React.FC<RecipesPageProps> = ({
  ...
  const { recipes, isLoading, error, reload } = usePublicRecipes({
  ...
  return (
    <div className="min-h-screen bg-[#F7F5EF] pt-28 pb-20 text-left">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl border border-[#D6A146]/20 shadow-xs p-3 sm:p-4 mb-6">
        ...
        <div className="flex items-center justify-between mb-4 px-1">
          <p className="text-xs sm:text-sm text-gray-600">
            Showing{" "}
            <strong className="text-[#1D1D1D] font-semibold">{recipes.length}</strong>{" "}
