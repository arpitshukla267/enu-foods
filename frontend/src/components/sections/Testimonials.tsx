    ...
    <section id="testimonials-section" className="py-20 lg:py-28 bg-[#1E3A2B] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-xs font-medium uppercase tracking-widest text-[#D6A146] font-btn">
            Voice Of Indian Kitchens
          </span>
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-semibold text-white mt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {TESTIMONIALS.map((testimonial) => (
            ...
            >
              ...
              <div>
                {/* Word Rating Label */}
                <div className="text-[#D6A146] text-xs font-medium mb-3">
              ...
              <div className="mt-6 pt-4 border-t border-white/10 flex items-center gap-3">
                ...
                />
                <div>
                  <div className="font-heading text-sm font-medium text-white flex items-center gap-1">
