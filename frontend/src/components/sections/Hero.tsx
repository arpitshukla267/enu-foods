          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <button
                ...
                className="mt-4 inline-flex items-center gap-1 md:gap-2 rounded-full bg-[#D6A146] px-5 py-2.5 text-xs md:font-medium uppercase tracking-wide text-black transition-all duration-300 hover:bg-[#c4913b] hover:gap-3 active:scale-95 sm:mt-6 sm:px-6 sm:py-3 sm:text-sm"
              >
                {slide.ctaLabel}
