          ...
          {tab === "login" ? (
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-[#284C38] hover:bg-[#1E3A2B] disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold text-sm py-2.5 rounded-md transition-colors"
              >
