...
export const WhyChooseUs: React.FC = () => {
  ...
  return (
    <section id="why-choose-enu-section" className="py-20 lg:py-28 bg-[#F7F5EF] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1D1D1D] mt-1">
            Why ENU Foods Belongs In Your Kitchen
          </h2>
          <p className="font-body text-gray-600 mt-2 text-base font-light">
            We blend century-old culinary tradition with modern cold-milling technology.
          </p>
        </div>
          ...
          {WHY_CHOOSE_ENU.map((item, idx) => (
            ...
            >
              <div>
                ...
                <h3 className="font-heading text-2xl font-bold text-[#1D1D1D] group-hover:text-[#284C38] transition-colors">
                  {item.title}
                </h3>
                <p className="font-body text-sm text-gray-600 mt-2 leading-relaxed font-light">
                  {item.description}
                </p>
              </div>
