...
export const ComboDetailPage: React.FC<ComboDetailPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#F7F5EF] pt-24 sm:pt-28 pb-20 text-left font-body">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-7 border border-[#D6A146]/25 shadow-sm mb-8 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="relative w-full md:w-56 h-48 sm:h-52 rounded-2xl overflow-hidden shrink-0 bg-[#1E3A2B]">
            ...
            />
            <div className="absolute top-3 left-3 bg-[#C86D39] text-white text-[11px] font-bold px-2.5 py-1 rounded-full shadow-md flex items-center gap-1">
              <Tag className="w-3 h-3" />
              <span>SAVE {combo.discountPercent}%</span>
            </div>
            {combo.badge && (
              <div className="absolute top-3 right-3 bg-[#D6A146] text-[#1D1D1D] text-[10px] font-bold uppercase px-2 py-0.5 rounded shadow font-btn">
                {combo.badge}
              </div>
            )}
          </div>
          ...
          <div className="flex-1 w-full flex flex-col justify-between">
            <div>
              <span className="text-xs font-bold text-[#C86D39] uppercase tracking-wider font-btn">
                {combo.tag}
              </span>
              <h1 className="font-heading text-2xl sm:text-3xl font-bold text-[#1D1D1D] mt-1 mb-2">
                {combo.title}
              </h1>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-gray-100">
              <div>
                <div className="flex items-baseline gap-2">
                  <span className="text-2xl sm:text-3xl font-bold text-[#284C38]">
                    ₹{comboPrice}
                  </span>
              ...
              <button
                ...
                className={`py-3 px-6 rounded-xl font-btn font-bold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-md transition-all shrink-0 ${
                  isJustAdded
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-heading text-lg sm:text-xl font-bold text-[#1D1D1D]">
                ...
                >
                  ...
                  <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-xl overflow-hidden shrink-0 bg-gray-50 border border-gray-100">
                    <img
                      ...
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute top-1 left-1 w-5 h-5 rounded-full bg-[#1E3A2B] text-[#D6A146] text-[10px] font-bold flex items-center justify-center font-btn">
                      #{index + 1}
                    </div>
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center justify-between gap-2 mb-1">
                      <div className="flex items-center gap-2">
                        <h3 className="font-heading text-base sm:text-lg font-bold text-[#1D1D1D]">
                          {p.name}
                        </h3>
                        <span className="text-[11px] font-bold text-[#284C38] bg-[#F7F5EF] border border-[#284C38]/20 px-2 py-0.5 rounded-md">
                          {item.weight} Pack
                        </span>
                      </div>
